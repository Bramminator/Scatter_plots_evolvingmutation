...
long_pop_cost_frame %>%
  ...
  ggsave('~/Documents/strepto/scatter_popsize_cost_em_nem/scatter_2500_maxcost06.png',
         height = 210,
         width  = 297,
         units= 'mm',
         dpi= 150)
...
long_pop_cost_frame %>%
  ...
  ggsave('~/Documents/strepto/scatter_popsize_cost_em_nem/scatter_5000_maxcost06.png',
         height = 210,
         width  = 297,
         units= 'mm',
         dpi= 150)
...
long_pop_cost_frame %>%
  ...
  ggsave('~/Documents/strepto/scatter_popsize_cost_em_nem/scatter_7500_maxcost06.png',
         height = 210,
         width  = 297,
         units= 'mm',
         dpi= 150)
